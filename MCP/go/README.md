# APIMATIC API Transformer MCP Server

This MCP (Model Content Protocol) server provides access to APIMATIC API Transformer API functionality through HTTP, HTTPS, and STDIO transport modes.
